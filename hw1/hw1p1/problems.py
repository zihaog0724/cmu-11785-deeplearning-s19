...
problems = {
    ...
    'test_linear_classifier_forward': ('Linear Classifier (forward)', 3),
    'test_linear_classifier_backward': ('Linear Classifier (backward)', 3),
    'test_linear_classifier_step': ('Linear Classifier (step)', 3),
    ...
    # 'test_train_statistics' :('Train statistics', 10)
}
